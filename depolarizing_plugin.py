...
from qat.core.circuit_builder.matrix_util import np_to_circ, circ_to_np, get_predef_generator
...
def make_matrix(hamiltonian):
    ...
    mat += hamiltonian.constant_coeff*np.eye(2**hamiltonian.nbqbits)
